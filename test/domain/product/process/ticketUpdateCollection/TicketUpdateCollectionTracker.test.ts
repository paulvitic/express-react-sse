...
import {TicketUpdateCollectionStarted, UpdatedTicketsListFetched} from "../../../../../server/domain/product/event";
...
describe("on event", () => {
    ...
    test("", () => {
        ...
        mockCollectionRepo.findLatestByProject = jest.fn().mockImplementationOnce(devProjectId => {
